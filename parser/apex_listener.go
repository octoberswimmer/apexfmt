...
type apexListener interface {
	...
	// EnterApexDbUpsertExpression is called when entering the apexDbUpsertExpression production.
	EnterApexDbUpsertExpression(c *ApexDbUpsertExpressionContext)
	...
	// ExitApexDbUpsertExpression is called when exiting the apexDbUpsertExpression production.
	ExitApexDbUpsertExpression(c *ApexDbUpsertExpressionContext)
